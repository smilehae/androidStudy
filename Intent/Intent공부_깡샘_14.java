...
public class Lab14_2Activity extends AppCompatActivity implements View.OnClickListener{
    ...
    public void onClick(View view) {
        if(view == contactsBtn){
        ...
        else if(view == cameraDataBtn){
            Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
            startActivityForResult(intent,30);
        }
        else if(view == cameraFileBtn){
            if (ContextCompat.checkSelfPermission(this, Manifest.permission.WRITE_EXTERNAL_STORAGE )== PackageManager.PERMISSION_GRANTED) {
                try{
                    ...
                    Uri photoURI = FileProvider.getUriForFile(Lab14_2Activity.this,"com.example.a14_2.fileprovider",filePath);
                    Intent intent = new Intent(MediaStore.ACTION_IMAGE_CAPTURE);
            ...
            if(ContextCompat.checkSelfPermission(this,Manifest.permission.CALL_PHONE) == PackageManager.PERMISSION_GRANTED){
                Intent intent = new Intent(Intent.ACTION_CALL,Uri.parse("tel:010-5062-4634"));
                startActivity(intent);
            }
            else {
